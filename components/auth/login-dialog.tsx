...
export function LoginDialog({ open, onOpenChange, role }: LoginDialogProps) {
  ...
  const handleGoogleSignIn = () => {
    ...
    // Call signInWithGoogle synchronously without await to prevent popup blocking
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            {role === "organizer" ? "Event Organizer" : "Attendee"} Login
          </DialogTitle>
          <DialogDescription>
            Sign in or create an account as {role === "organizer" ? "an organizer" : "an attendee"}
          </DialogDescription>
        </DialogHeader>
